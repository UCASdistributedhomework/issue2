...
class LockerIf {
 public:
  virtual ~LockerIf() {}
  virtual bool client_register(const int32_t client_id, const int32_t message_index, const bool is_retry) = 0;
  virtual bool client_exit(const int32_t client_id, const int32_t message_index, const bool is_retry) = 0;
  virtual bool lock_request_register(const int32_t client_id, const int32_t message_index, const bool is_retry) = 0;
  virtual bool lock_request_check(const int32_t client_id, const int32_t message_index, const bool is_retry) = 0;
  virtual bool lock_request_release(const int32_t client_id, const int32_t message_index, const bool is_retry) = 0;
};
...
typedef struct _Locker_client_register_args__isset {
  _Locker_client_register_args__isset() : client_id(false), message_index(false), is_retry(false) {}
  bool client_id :1;
  bool message_index :1;
  bool is_retry :1;
...
class Locker_client_register_args {
 public:
  ...
  Locker_client_register_args() : client_id(0), message_index(0), is_retry(0) {
  }
  ...
  void __set_message_index(const int32_t val);
  ...
  bool operator == (const Locker_client_register_args & rhs) const
  {
    if (!(client_id == rhs.client_id))
      return false;
    if (!(message_index == rhs.message_index))
      return false;
...
typedef struct _Locker_client_exit_args__isset {
  _Locker_client_exit_args__isset() : client_id(false), message_index(false), is_retry(false) {}
  bool client_id :1;
  bool message_index :1;
  bool is_retry :1;
...
class Locker_client_exit_args {
 public:
  ...
  Locker_client_exit_args() : client_id(0), message_index(0), is_retry(0) {
  }
...
typedef struct _Locker_lock_request_register_args__isset {
  _Locker_lock_request_register_args__isset() : client_id(false), message_index(false), is_retry(false) {}
  bool client_id :1;
  bool message_index :1;
  bool is_retry :1;
...
class Locker_lock_request_register_args {
 public:
  ...
  Locker_lock_request_register_args() : client_id(0), message_index(0), is_retry(0) {
  }
...
typedef struct _Locker_lock_request_check_args__isset {
  _Locker_lock_request_check_args__isset() : client_id(false), message_index(false), is_retry(false) {}
  bool client_id :1;
  bool message_index :1;
  bool is_retry :1;
...
class Locker_lock_request_check_args {
 public:
  ...
  Locker_lock_request_check_args() : client_id(0), message_index(0), is_retry(0) {
  }
...
typedef struct _Locker_lock_request_release_args__isset {
  _Locker_lock_request_release_args__isset() : client_id(false), message_index(false), is_retry(false) {}
  bool client_id :1;
  bool message_index :1;
  bool is_retry :1;
...
class Locker_lock_request_release_args {
 public:
  ...
  Locker_lock_request_release_args() : client_id(0), message_index(0), is_retry(0) {
  }
...
class LockerClient : virtual public LockerIf {
 ...
 public:
  ...
  bool client_register(const int32_t client_id, const int32_t message_index, const bool is_retry);
  void send_client_register(const int32_t client_id, const int32_t message_index, const bool is_retry);
  bool recv_client_register();
  bool client_exit(const int32_t client_id, const int32_t message_index, const bool is_retry);
  void send_client_exit(const int32_t client_id, const int32_t message_index, const bool is_retry);
  bool recv_client_exit();
  bool lock_request_register(const int32_t client_id, const int32_t message_index, const bool is_retry);
  void send_lock_request_register(const int32_t client_id, const int32_t message_index, const bool is_retry);
  bool recv_lock_request_register();
  bool lock_request_check(const int32_t client_id, const int32_t message_index, const bool is_retry);
  void send_lock_request_check(const int32_t client_id, const int32_t message_index, const bool is_retry);
  bool recv_lock_request_check();
  bool lock_request_release(const int32_t client_id, const int32_t message_index, const bool is_retry);
  void send_lock_request_release(const int32_t client_id, const int32_t message_index, const bool is_retry);
...
class LockerMultiface : virtual public LockerIf {
 ...
 public:
  bool client_register(const int32_t client_id, const int32_t message_index, const bool is_retry) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->client_register(client_id, message_index, is_retry);
    }
    return ifaces_[i]->client_register(client_id, message_index, is_retry);
  }
  ...
  bool client_exit(const int32_t client_id, const int32_t message_index, const bool is_retry) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->client_exit(client_id, message_index, is_retry);
    }
    return ifaces_[i]->client_exit(client_id, message_index, is_retry);
  }
  ...
  bool lock_request_register(const int32_t client_id, const int32_t message_index, const bool is_retry) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->lock_request_register(client_id, message_index, is_retry);
    }
    return ifaces_[i]->lock_request_register(client_id, message_index, is_retry);
  }
  ...
  bool lock_request_check(const int32_t client_id, const int32_t message_index, const bool is_retry) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->lock_request_check(client_id, message_index, is_retry);
    }
    return ifaces_[i]->lock_request_check(client_id, message_index, is_retry);
  }
  ...
  bool lock_request_release(const int32_t client_id, const int32_t message_index, const bool is_retry) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->lock_request_release(client_id, message_index, is_retry);
    }
    return ifaces_[i]->lock_request_release(client_id, message_index, is_retry);
  }
  ...
  LockerConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
 ...
 public:
  ...
  bool client_register(const int32_t client_id, const int32_t message_index, const bool is_retry);
  int32_t send_client_register(const int32_t client_id, const int32_t message_index, const bool is_retry);
  bool recv_client_register(const int32_t seqid);
  bool client_exit(const int32_t client_id, const int32_t message_index, const bool is_retry);
  int32_t send_client_exit(const int32_t client_id, const int32_t message_index, const bool is_retry);
  bool recv_client_exit(const int32_t seqid);
  bool lock_request_register(const int32_t client_id, const int32_t message_index, const bool is_retry);
  int32_t send_lock_request_register(const int32_t client_id, const int32_t message_index, const bool is_retry);
  bool recv_lock_request_register(const int32_t seqid);
  bool lock_request_check(const int32_t client_id, const int32_t message_index, const bool is_retry);
  int32_t send_lock_request_check(const int32_t client_id, const int32_t message_index, const bool is_retry);
  bool recv_lock_request_check(const int32_t seqid);
  bool lock_request_release(const int32_t client_id, const int32_t message_index, const bool is_retry);
  int32_t send_lock_request_release(const int32_t client_id, const int32_t message_index, const bool is_retry);
